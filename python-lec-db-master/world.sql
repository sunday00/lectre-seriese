...
BEGIN TRANSACTION;
CREATE TABLE `city` (`ID`, `Name`, `CountryCode`, `District`, `Population`);
...
CREATE TABLE `country` (`Code`, `Name`, `Continent`, `Region`, `SurfaceArea`, `IndepYear`, `Population`, `LifeExpectancy`, `GNP`, `GNPOld`, `LocalName`, `GovernmentForm`, `HeadOfState`, `Capital`, `Code2`);
...
CREATE TABLE `countrylanguage` (`CountryCode`, `Language`, `IsOfficial`, `Percentage`);
